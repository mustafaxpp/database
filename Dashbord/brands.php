...
?>
  ...
  <div class="container mt-5 ">
    <div class="row">
      <div class="col-5">
        <form action="brandadd.php" class="form-signin" method="post" enctype="multipart/form-data">
          <h1 class="h3 mb-3 font-weight-normal mt-5">Add New brand</h1>
          <?php
          ...
          ?>
          <label for="inputEmail" class="sr-only"> Add brand name </label>
          <label for="logo" class=" wow fadeInDown slow">insert brand name</label>
          <input type="text" name="productname" id="inputEmail" class="form-control wow fadeInDown slow mb-2" placeholder="Enter brand name" autofocus>
          <input type="text" name="productnamear" id="inputEmail" class="form-control wow fadeInDown slow" placeholder="اسم البراند" autofocus>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td class=""><img src="<?= $tabledata['logo'] ?>" width="100" ></td>
